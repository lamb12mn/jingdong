  ...
  <div class="cart">
    ...
    <main>
      <div class="opearor">
        ...
        <div class="opearor-edit" @click="(()=>{itemShow =!itemShow})" v-html="itemShow ?'编辑商品':`总数量为：${price}`"></div>
      </div>
      <div class="content">
...
export default {
  ...
  setup () {
    ...
    const { onSubmit, onClickLink, handelBackClick, clearCount, cartGoods, price, total } = useSubmitEffect()
    return {
      handelBackClick,
      checked,
      checkAll,
