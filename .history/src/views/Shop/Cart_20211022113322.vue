    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="content-cards">
          <van-checkbox-group v-model="checked" ref="checkboxGroup" v-for="value in cartGoods.length" :key="value">
            <div  v-for="(item,index) in cartGoods" :key="item.id"  :name="value">
 <van-checkbox>
     <van-card
                :num="item.count"
                :price="item.price"
...
export default {
  ...
  setup () {
    ...
    const { onSubmit, onClickLink, handelBackClick, clearCount, cartGoods, price } = useSubmitEffect()
    return {
      handelBackClick,
      checked,
      checkAll,
