...
const useCartEffect = (shopId, tabId) => {
  ...
  return { total, allChecked, cartList, price, productList, arr, changeCartItemInfo, changeCartItemChecked, cleanCartProducts }
}
...
export default {
  ...
  setup () {
    ...
    const { total, cartList, arr, price, productList, changeCartItemInfo, changeCartItemChecked } = useCartEffect(shopId, activeIndex)
    getItemData()
    return {
      value,
      shopId,
