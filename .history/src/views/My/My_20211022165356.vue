  ...
  <div class="my">
    ...
    <main>
      ...
      <div class="content">
        ...
        <div class="content-box">
          <div class="c-b-Item" @click="toCoupons">
            <p class="text">2</p>
            <p>优惠券</p>
          </div>
          <div class="c-b-Item">
...
const useRecommendEffect = () => {
  ...
  const toCoupons = () => {
    // console.log(1)
    const router = useRouter()
    router.push({ path: '/coupons', query: { id: 1 } })
  }
  const { items } = toRefs(data)
  return { items, getItemData, handelBackClick, toCoupons }
}
export default {
  name: 'My',
  setup () {
    ...
    const { items, getItemData, handelBackClick, toCoupons } = useRecommendEffect()
    getItemData()
    return { items, getItemData, handelBackClick, toCoupons }
  }
}
